...
class Chossepage extends StatefulWidget {
  ...
  Choosepagewidget createState() => Choosepagewidget(Amanj, bus1, name, phone,startingplace,destinationplace,selecteddate,jprice);
  //}
}
...
class Choosepagewidget extends State<Chossepage> {
  ...
  String selecteddate;
  String jprice;
  Choosepagewidget(this.Amanj, this.bus1, this.name, this.phone,this.startingplace,this.destinationplace,this.selecteddate,this.jprice);
